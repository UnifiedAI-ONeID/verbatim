    ...
    <div style={styles.configWarningOverlay}>
        <div style={styles.configWarningBox}>
            ...
            <ol style={{lineHeight: 1.6}}>
                ...
                <li>Paste it into the `firebaseConfig` constant in <strong>index.tsx</strong> to replace the placeholder values.</li>
            </ol>
...
const LoginView = ({ prompt, onSignIn, error }: { prompt: string; onSignIn: () => void; error: string | null; }) => {
    const { t } = useLocalization();
    return (
