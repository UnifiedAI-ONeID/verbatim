...
export const styles: { [key: string]: CSSProperties } = {
    ...
    mainContent: { flex: 1, overflowY: 'auto', paddingBottom: '80px', display: 'flex', flexDirection: 'column' },
    ...
    themeToggleButton: { background: 'none', border: 'none', fontSize: '1.5rem', cursor: 'pointer', padding: '8px', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
    ...
    recordButtonContainer: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexGrow: 1, textAlign: 'center', width: '100%' },
    recordButton: { width: '180px', height: '180px', borderRadius: '50%', border: 'none', backgroundColor: 'var(--accent-primary)', color: 'var(--accent-primary-text)', fontSize: '5rem', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.3s ease', boxShadow: '0 4px 25px color-mix(in srgb, var(--accent-primary) 30%, transparent), 0 2px 10px rgba(0,0,0,0.2)' },
    recordButtonRecording: { backgroundColor: 'var(--danger)', boxShadow: '0 0 30px color-mix(in srgb, var(--danger) 50%, transparent)', animation: 'pulse 1.5s infinite' },
    recordButtonDisabled: { backgroundColor: 'var(--bg-3)', color: 'var(--text-tertiary)', cursor: 'not-allowed', boxShadow: 'none' },
    recordButtonText: { marginTop: '24px', fontSize: '1.25rem', color: 'var(--text-secondary)', minHeight: '1.5rem', fontWeight: 600 },
    statusContainer: { minHeight: '24px', textAlign: 'center', marginTop: '16px' },
    recordFooter: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', width: '100%', paddingBottom: '10px' },

    // --- Sessions View ---
    sessionsView: { padding: '16px' },
    ...
    sessionItem: { backgroundColor: 'var(--bg-2)', padding: '16px 20px', borderRadius: '12px', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', border: '1px solid var(--border-color)', transition: 'transform 0.2s ease, box-shadow 0.2s ease' },
    sessionItemInfo: { display: 'flex', flexDirection: 'column', gap: '4px' },
    sessionItemTitle: { fontSize: '1.1rem', fontWeight: 600 },
    ...
    editSpeakerButton: { background: 'none', border: 'none', cursor: 'pointer', fontSize: '1rem', padding: '8px' },
    ...
    loginView: { flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', textAlign: 'center', gap: '16px' },
