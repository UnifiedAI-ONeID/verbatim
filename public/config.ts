...
export const translations = {
    en: {
        ...
        offlineRecordingError: 'An internet connection is required to start a new recording session.',
    ...
    es: {
        ...
        offlineRecordingError: 'Se necesita una conexión a internet para iniciar una nueva sesión de grabación.',
    ...
    'zh-CN': {
        ...
        offlineRecordingError: '开始新的录音会话需要网络连接。',
     ...
     'zh-TW': {
        ...
        offlineRecordingError: '開始新的錄製會話需要網路連線。',
